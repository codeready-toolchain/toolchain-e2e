...
Although the e2e tests are in the separated repository that the actual operators are, it's still possible to run them against the current code that is at HEAD of the operator repositories.
