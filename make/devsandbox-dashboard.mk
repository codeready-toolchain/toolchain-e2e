...
e2e-run-devsandbox-dashboard:
	...
	@HOST_NS=$(HOST_NS) MEMBER_NS=$(MEMBER_NS) MEMBER_NS_2=$(MEMBER_NS_2) REGISTRATION_SERVICE_NS=$(HOST_NS) SECOND_MEMBER_MODE=true go test "./test/e2e/devsandbox-dashboard" -v -timeout=10m -failfast
