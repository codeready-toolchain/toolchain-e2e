...
.PHONY: setup-kubefed
setup-kubefed:
	curl -sSL https://raw.githubusercontent.com/alexeykazakov/toolchain-common/kubefed/scripts/add-cluster.sh | bash -s -- -t member -mn $(MEMBER_NS) -hn $(HOST_NS) -s
	curl -sSL https://raw.githubusercontent.com/alexeykazakov/toolchain-common/kubefed/scripts/add-cluster.sh | bash -s -- -t host -mn $(MEMBER_NS) -hn $(HOST_NS) -s
