...
func TestNSTemplateTiers(t *testing.T) {
	...
	tiersToCheck := []string{"advanced", "basedeactivationdisabled", "baseextended", "baseextendedidling", "baselarge", "hackathon", "test", "appstudio", "base-single-ns", "base"}
...
func TestTierTemplates(t *testing.T) {
	...
	// verify that we have 28 tier templates (base: 3, base-single-ns: 2, baselarge: 3, baseextended: 3, baseextendedidling: 3, basedeactivationdisabled: 3, advanced: 3, test: 3, hackathon: 3, appstudio: 2)
	require.NoError(t, err)
