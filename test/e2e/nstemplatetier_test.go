...
func TestNSTemplateTiers(t *testing.T) {
	...
	tiersToCheck := []string{"advanced", "baseextendedidling", "baselarge", "test", "appstudio", "base1ns", "base1nsnoidling", "base"}
...
func TestTierTemplates(t *testing.T) {
	...
	// verify that we have 19 tier templates (base: 3, base1ns: 2, base1nsnoidling: 2, baselarge: 3, baseextendedidling: 3, advanced: 3, test: 3, appstudio: 2)
	require.NoError(t, err)
	...
	assert.True(t, len(allTiers.Items) >= 21)
}
