...
func TestNSTemplateTiers(t *testing.T) {
	...
	tiersToCheck := []string{"advanced", "baseextendedidling", "baselarge", "test", "appstudio", "base1ns", "basenoidling", "base"}
...
func TestTierTemplates(t *testing.T) {
	...
	// verify that we have 19 tier templates (base: 3, base1ns: 2, basenoidling: 2, baselarge: 3, baseextendedidling: 3, advanced: 3, test: 3, appstudio: 2)
	require.NoError(t, err)
