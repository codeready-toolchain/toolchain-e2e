...
replace (
	...
	github.com/codeready-toolchain/toolchain-common v0.0.0-20230504150220-4ca56e68a966 => github.com/ranakan19/toolchain-common v0.0.0-20230525180055-f75a15d67e5a
)
