...
replace (
	...
	github.com/codeready-toolchain/toolchain-common v0.0.0-20200930070243-e124e69e7a0d => github.com/tinakurian/toolchain-common v0.0.0-20210216124316-080275ce4c11
